...
# Trial setting
subject = 'AB02_Rajiv'  # Change this for different subjects
trial_name = f'{subject}_OnlineValidation'  # Change this for different trials
trial_start_sec = 5
...
# Body mass setting
body_mass_kg = 57.9  # kg

# Model path
# trt_engine_path = '/home/metamobility2/Jimin/Trained Models IMUonly_fixed/SD_ALL_IMUonly_fixed/SD_ALL_IMUonly_fixed.trt'
# trt_engine_path = '/home/metamobility2/Jimin/Trained Models IMUonly_fixed/SD Models/SD_AB08_Adrian_IMUonly_fixed_DEP/SD_AB08_Adrian_IMUonly_fixed_DEP.trt'
trt_engine_path = '/home/metamobility2/Jimin/Trained Models IMUonly_fixed/SemiDEP Models/SI_AB02_Rajiv_TL_IMUonly_fixed_SemiDEP/SI_AB02_Rajiv_TL_IMUonly_fixed_SemiDEP.trt'

scale_factor_percent = 25
desired_delay_ms = 125

scale_factor = scale_factor_percent/100
delay_factor = int(desired_delay_ms/10 - 5)
...
def main():
    ...
    while True:
        ...
        # 첫 번째 펄스
        if current_time >= (2 + 5 + 30) and not first_pulse_sent:
        ...
        # 두 번째 펄스
        if current_time >= (2 + 5 + 30 + target_time_range) and not second_pulse_sent:
            send_gpio_pulse_start()
